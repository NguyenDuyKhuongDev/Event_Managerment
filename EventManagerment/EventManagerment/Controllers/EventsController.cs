...
namespace EventManagerment.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventID,CategoryID,Title,Description,StartTime,EndTime,Location")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventID,CategoryID,Title,Description,StartTime,EndTime,Location")] Event @event)
        {
            if (id != @event.EventID)
            {
                return NotFound();
